class AdultsController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:adult).permit(:first_name, :last_name, :address1, :address2, :city, :state, :zip_code, :time_zone, :birth, :rank, :leadership_position, :additional_leadership_positions, :sub_unit_id, :send_reminders, :adult_ids, :scout_ids)
      # params[:adult]
    end
end
