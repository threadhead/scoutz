class UnitsController < ApplicationController
  ...
  private
    ...
    def unit_params
      params.require(:unit).permit(:address1, :address2, :city, :state, :zip_code, :time_zone, :attach_consent_form, :use_consent_form, :consent_form, :url_consent_form, :home_address1, :home_address2, :home_zip_code, :home_state, :home_city, :home_map_url, :home_name)
    end
end
