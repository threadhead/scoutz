...
RSpec.describe 'User health forms' do
  ...
  context 'An adult users edit page' do
    ...
    before{ visit edit_unit_adult_url(@unit, @user) }

    it 'should have link to create new health form' do
       expect(page).to have_link('Edit health forms')
    end

    describe 'clicking the Edit health forms link' do
      describe 'when there are no existing health forms' do
        it 'clicking cancel returns to users edit page' do
          click_link 'Edit health forms'
          click_link 'Cancel'
          expect(page).to have_content('Edit Adult')
        end

        it 'clicking submt returns to users edit page' do
          click_link 'Edit health forms'
      ...
      describe 'when health form exists' do
        it 'clicking cancel returns to users edit page' do
          click_link 'Edit health forms'
          click_link 'Cancel'
          expect(page).to have_content('Edit Adult')
        ...
        it 'edits the existing health form and saves changes' do
          ...
          visit edit_unit_adult_url(@unit, @user)
          click_link 'Edit health forms'
          set_hidden_fields_form_date
